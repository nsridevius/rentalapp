...
public class RentalCarServiceDemo2 {
	...
	public static void main(String[] args) throws Exception {
		...
		String reg = rcs.reserveVehicle(CarType.VAN, today , 1);
		...
		Thread.sleep(3000);
		reg = rcs.reserveVehicle(CarType.VAN, tomorrow , 2);
		System.out.println("regsitration number " + reg);
		RentalCarService.getInstance().displayVehicleInfo(reg);
		RentalCarService.getInstance().displayQueueSizes();
		...
		Thread.sleep(3000);
		reg = rcs.reserveVehicle(CarType.VAN, plus3Days , 4);
		System.out.println("regsitration number " + reg);
		RentalCarService.getInstance().displayVehicleInfo(reg);
		RentalCarService.getInstance().displayQueueSizes();
		...
		System.out.println("**********************");
		Thread.sleep(3000);
		reg = rcs.reserveVehicle(CarType.VAN, tomorrow , 1);
		System.out.println("regsitration number " + reg);
		RentalCarService.getInstance().displayVehicleInfo(reg);
		RentalCarService.getInstance().displayQueueSizes();
